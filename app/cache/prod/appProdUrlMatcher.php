...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/course')) {
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/students/show$#s', $pathinfo, $matches)) {
            ...
            if (preg_match('#^/course/(?P<id>[^/]++)/manage/students/defined/show$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/group')) {
            ...
            if (preg_match('#^/group/(?P<groupId>[^/]++)/thread/deletePost/(?P<postId>[^/]++)/(?P<memberId>[^/]++)/(?P<threadOwnerId>[^/]++)/(?P<groupOwnerId>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/setting')) {
                ...
                if ($pathinfo === '/admin/setting/storage') {
                    return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\SettingController::storageAction',  '_route' => 'admin_setting_storage',);
                }
                ...
                if (0 === strpos($pathinfo, '/admin/setting/cloud/video_watermark')) {
                    ...
                    if ($pathinfo === '/admin/setting/cloud/video_watermark/upload') {
                        ...
                        return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\SettingController::cloudVideoWatermarkUploadAction',  '_route' => 'admin_setting_cloud_video_watermark_upload',);
                    }
                    ...
                    if ($pathinfo === '/admin/setting/cloud/video_watermark/remove') {
                        ...
                        return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\SettingController::cloudVideoWatermarkRemoveAction',  '_route' => 'admin_setting_cloud_video_watermark_remove',);
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/app')) {
                ...
                // admin_app_check_ownCopyrightUser
                if (0 === strpos($pathinfo, '/admin/app/check') && preg_match('#^/admin/app/check/(?P<userId>[^/]++)/ownCopyrightUser$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_check_ownCopyrightUser')), array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\AppController::checkOwnCopyrightUserAction',));
                }
        ...
        if (0 === strpos($pathinfo, '/mapi_v1')) {
            ...
            if (0 === strpos($pathinfo, '/mapi_v1/order') && preg_match('#^/mapi_v1/order/(?P<id>[^/]++)/submit_pay_request$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'mapi_order_submit_pay_request')), array (  '_controller' => 'Topxia\\MobileBundle\\Controller\\MobileOrderController::submitPayRequestAction',));
            }

            // topxia_mobile_alipay_notify
            if (preg_match('#^/mapi_v1/(?P<name>[^/]++)/alipay_notify$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'topxia_mobile_alipay_notify')), array (  '_controller' => 'Topxia\\MobileBundle\\Controller\\MobileAlipayController::payNotifyAction',));
            }

            // topxia_mobile_alipay_pay
            if ($pathinfo === '/mapi_v1/alipay_pay') {
                return array (  '_controller' => 'Topxia\\MobileBundle\\Controller\\MobileAlipayController::payAction',  '_route' => 'topxia_mobile_alipay_pay',);
            }

            // topxia_mobile_alipay_callback
            if (preg_match('#^/mapi_v1/(?P<name>[^/]++)/alipay_callback$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'topxia_mobile_alipay_callback')), array (  '_controller' => 'Topxia\\MobileBundle\\Controller\\MobileAlipayController::payCallBackAction',));
            }
